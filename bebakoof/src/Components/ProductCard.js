        ...
        <Box border="1px solid grey" w="100%" h="auto" p="10px">
            ...
            <Box border="2px solid rgb(234, 234, 234)" display="flex" p="5px" justifyContent="space-between">
                <Box  textAlign={"left"}>
                    ...
                    <Text as="b">₹ 499</Text>
                    <Text color={"#1d8802"}>You saved ₹550!</Text>
                ...
                <Box>
                    < Image boxSize="120px" src="https://images.bewakoof.com/t320/men-s-white-karma-circles-typography-oversized-t-shirt-489752-1667491984-1.jpg" />
                </Box>
            </Box>
