import {
    Box, Flex, Heading, Image, Text, Spacer, Input, VStack, Menu,
    MenuButton,
    MenuList,
    MenuItem,
    Button
...
import { LoginFunctionSuccess, LogoutFunctionSuccess } from '../AuthReducer/action';
...
const[toggle,Settoggle] = useState(true)
  ...
  console.log(auth)
    ...
    //        isAuth?dispatch(LoginFunctionSuccess()):dispatch(LogoutFunctionSuccess())
    //     }
    // },[])
                    ...
                    <Menu position="absolute" top={0}   >
                        ...
                        <MenuList width={["200px", "270px", "270px", "270px"]}   >
                            <MenuItem _hover={{ bg: 'gray.400', color: "white", transform: "scale(1.2)" }} >  <Flex >
                                {auth=="true" ? <Heading fontSize={"md"} >Hello {names}</Heading> : <VStack>  <Link to="/Signup" > <Heading fontSize={"md"}  >Welcome Guest</Heading></Link> <Link to="/Signup" ><Text >Login/Signup</Text></Link> </VStack>}  </Flex></MenuItem>
                            ...
                            <MenuItem _hover={{ bg: 'gray.400', color: "white", transform: "scale(1.2)" }}> <Link> <Flex p={2} alignItems="center"  ><Text mr={5} >Made in India Sale</Text> <Image width="20%" src="https://images.bewakoof.com/nav_menu/mad-india-circle-icon-1673616489.png" /> </Flex> </Link></MenuItem>
                            ...
                            <MenuItem _hover={{ bg: 'gray.400', color: "white", transform: "scale(1.2)" }}>  {auth=="true"? <Link><Text onClick={logout} >Logout</Text></Link> : ""}</MenuItem>
                        </MenuList>
